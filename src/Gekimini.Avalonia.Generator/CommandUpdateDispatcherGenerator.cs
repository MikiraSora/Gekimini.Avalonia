...
[Generator]
public class CommandUpdateDispatcherGenerator : IIncrementalGenerator
{
        ...
        context.RegisterSourceOutput(methodsWithAttr.Collect(), static (spc, methods) =>
        {
            ...
            foreach (var group in groups)
            {
                ...
                foreach (var item in group)
                {
                    ...
                    sb.AppendLine($"                    {item.MethodName}(command);");
                    sb.AppendLine("                    break;");
                }
                ...
                var hintName = $"{className}_CommandUpdateDispatcher.g.cs";
    ...
    private static MethodInfo? GetMethodInfo(GeneratorSyntaxContext ctx)
    {
        ...
        foreach (var attr in methodSymbol.GetAttributes())
        {
            ...
            if (attrClass.Name != "GenerateCommandUpdateDispatcherAttribute`1" && attrClass.Name != "GenerateCommandUpdateDispatcherAttribute")
                continue;
